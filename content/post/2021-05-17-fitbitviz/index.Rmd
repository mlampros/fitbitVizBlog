---
title: "2021-05-17  to  2021-05-23  ( Fitbit Visualizations )"
date: "2021-05-17"
---
...
heart_dat = readRDS(file = "heart_dat_2021-05-17.RDS")
heart_dat$plt
...
sleep_ts = readRDS(file = "sleep_ts_2021-05-17.RDS")
...
log_id = readRDS(file = "log_id_2021-05-17.RDS")
...
if (!flag_no_gps_data) {
  ...
  res_tcx = readRDS(file = "res_tcx_2021-05-17.RDS")
...
if (!flag_no_gps_data) {
  ...
  sf_rst_ext = readRDS(file = "sf_rst_ext_2021-05-17.RDS")
}
