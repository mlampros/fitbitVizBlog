---
title: "2021-05-10  to  2021-05-16  ( Fitbit Visualizations )"
---
...
### [**heart rate time series**](#anchor_heart_rate)
<a id="anchor_heart_rate"></a>
...
heart_dat = readRDS(file = "heart_dat_2021-05-10.RDS")
heart_dat$plt
...
### [**heart rate variability during sleep time**](#anchor_heart_var)
<a id="anchor_heart_var"></a>
...
sleep_ts = readRDS(file = "sleep_ts_2021-05-10.RDS")
...
log_id = readRDS(file = "log_id_2021-05-10.RDS")
...
if (!flag_no_gps_data) {
  ...
  res_tcx = readRDS(file = "res_tcx_2021-05-10.RDS")
...
### **Leaflet Map of Point Coordinates**
...
### **3-dimensional Rayshader Map of the Activities**
...
if (!flag_no_gps_data) {
  ...
  sf_rst_ext = readRDS(file = "sf_rst_ext_2021-05-10.RDS")
}
...
if (!flag_no_gps_data) {
  ...
  raysh_rst = raster::raster("raysh_rst_2021-05-10.tif")
}
