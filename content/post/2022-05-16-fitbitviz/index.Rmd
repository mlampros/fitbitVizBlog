---
title: "2022-05-16  to  2022-05-22  ( Fitbit Visualizations )"
date: "2022-05-16"
---
...
heart_dat = readRDS(file = "heart_dat_2022-05-16.RDS")
heart_dat$plt
...
sleep_ts = readRDS(file = "sleep_ts_2022-05-16.RDS")
...
log_id = readRDS(file = "log_id_2022-05-16.RDS")
...
if (!flag_no_gps_data) {
  ...
  res_tcx = readRDS(file = "res_tcx_2022-05-16.RDS")
...
if (!flag_no_gps_data) {
  ...
  sf_rst_ext = readRDS(file = "sf_rst_ext_2022-05-16.RDS")
}
