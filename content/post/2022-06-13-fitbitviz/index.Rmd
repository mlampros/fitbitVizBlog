---
title: "2022-06-13  to  2022-06-19  ( Fitbit Visualizations )"
date: "2022-06-13"
---
...
heart_dat = readRDS(file = "heart_dat_2022-06-13.RDS")
heart_dat$plt
...
sleep_ts = readRDS(file = "sleep_ts_2022-06-13.RDS")
...
log_id = readRDS(file = "log_id_2022-06-13.RDS")
...
if (!flag_no_gps_data) {
  ...
  res_tcx = readRDS(file = "res_tcx_2022-06-13.RDS")
...
if (!flag_no_gps_data) {
  ...
  sf_rst_ext = readRDS(file = "sf_rst_ext_2022-06-13.RDS")
}
