---
title: "2022-06-20  to  2022-06-26  ( Fitbit Visualizations )"
date: "2022-06-20"
---
...
heart_dat = readRDS(file = "heart_dat_2022-06-20.RDS")
heart_dat$plt
...
sleep_ts = readRDS(file = "sleep_ts_2022-06-20.RDS")
...
log_id = readRDS(file = "log_id_2022-06-20.RDS")
...
if (!flag_no_gps_data) {
  ...
  res_tcx = readRDS(file = "res_tcx_2022-06-20.RDS")
...
if (!flag_no_gps_data) {
  ...
  sf_rst_ext = readRDS(file = "sf_rst_ext_2022-06-20.RDS")
}
